...
## Правила сборки
- **Скелет страницы — из каталога шаблонов, не на глаз.** Если Дирижёр не дал
  готовый макет-основу, определи тип экрана и возьми схему из
  `ux-lab/foundation/templates/` (Create / Notification / Sidemenu / SidePage /
  Filters) + раскладку `ux-lab/foundation/layout.md`. Собирай НА этом скелете.
  Подходящего шаблона нет — сообщи Дирижёру и собери по ближайшему, раскладку с
  нуля не выдумывай.
