...
выбора при утверждении. Если сомневается между направлениями и хочет доп. сигнал
до выбора — можно прогнать формулировки через плагин **claude-persona**
(`ux-lab/playbook/4-testing.md`) синтетической панелью, это дешевле, чем строить
все три в Figma. Решение всё равно за дизайнером, панель — только один из входов.
